...
dscl . -create /Users/caspersvc RealName "caspersvc"
...
dscl . -passwd /Users/caspersvc "Fri3ndlyGh0st"  # Obviously, use something else here
...
/System/Library/CoreServices/RemoteManagement/ARDAgent.app/Contents/Resources/kickstart -activate -configure -access -on -users administrator,daladmin,admin,casperscreensharing,caspersvc -privs -all -restart -agent
